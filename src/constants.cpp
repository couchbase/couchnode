...
void Constants::InitAutogen(Napi::Env env, Napi::Object exports)
{
    ...
    exports.Set(
        "query_profile_mode",
        cbppEnumToJs<couchbase::core::query_profile_mode>(
            env, {
                     {"off", couchbase::core::query_profile_mode::off},
                     {"phases", couchbase::core::query_profile_mode::phases},
                     {"timings", couchbase::core::query_profile_mode::timings},
                 }));

    exports.Set(
        "query_scan_consistency",
        cbppEnumToJs<couchbase::core::query_scan_consistency>(
            env, {
                     {"not_bounded",
                      couchbase::core::query_scan_consistency::not_bounded},
                     {"request_plus",
                      couchbase::core::query_scan_consistency::request_plus},
                 }));
