...
setup(function(err, cb) {
    ...
    cb.incr( testkey,  function(err, key, cas, value){
        ...
        cb.incr( testkey,  function(err, key, cas, value){
            ...
            cb.incr( testkey,  function(err, key, cas, value){
                ...
                cb.decr( testkey,  function(err, key, cas, value){
    ...
    cb.incr( testkey2,  {offset : 10},  function(err, key, cas, value){
        ...
        cb.incr( testkey2,  {offset : 10},  function(err, key, cas, value){
            ...
            cb.incr( testkey2, {offset : 5},  function(err, key, cas, value){
                assert.equal(value, 15, "Default Increment 3rd call with 5 : value should be 15 but it is "+ value);

                cb.decr( testkey2, {offset : 10},  function(err, key, cas, value){
    ...
    cb.incr( testkey5,  {expiry : 5}, function(err, key, cas, value){
        assert.equal(value, 0, "Default Increment test default value : value should be 0 but it is "+ value);
        setup.end();
    });


    cb.decr( testkey6,  {defaultValue : 50, expiry : 5}, function(err, key, cas, value){
