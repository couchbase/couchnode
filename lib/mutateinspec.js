...
class MutateInSpec {
  ...
  static _create(opType, path, value, options) {
    ...
    if (value === CasPlaceholder) {
      spec._flags |= binding.LCB_SUBDOCSPECS_F_XATTR_MACROVALUES;
      spec._data = '${document.cas}';
    }

    if (options.createPath) {
      spec._flags |= binding.LCB_SUBDOCSPECS_F_MKINTERMEDIATES;
    }

    if (options.xattr) {
      spec._flags |= binding.LCB_SUBDOCSPECS_F_XATTRPATH;
  ...
  static insert(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_DICT_ADD, path, JSON.stringify(value), options);
  }
  ...
  static upsert(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_DICT_UPSERT, path, JSON.stringify(value), options);
  }
  ...
  static replace(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_REPLACE, path, JSON.stringify(value), options);
  }
  ...
  static arrayAppend(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_ARRAY_ADD_LAST, path, JSON.stringify(value), options);
  }
  ...
  static arrayPrepend(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_ARRAY_ADD_FIRST, path, JSON.stringify(value), options);
  }
  ...
  static arrayInsert(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_ARRAY_INSERT, path, JSON.stringify(value), options);
  }
  ...
  static arrayAddUnique(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_ARRAY_ADD_UNIQUE, path, JSON.stringify(value), options);
  }
  ...
  static increment(path, value, options) {
    return this._create(
      binding.LCBX_SDCMD_COUNTER, path, JSON.stringify(+value), options);
  }
