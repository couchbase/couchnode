...
Bucket.prototype.touch = function(key, expiry, options, callback) {
  ...
  if (typeof expiry !== 'number' || expiry < 0) {
    var errmsg = 'Second argument needs to be 0 or a positive integer..';
...
/**
 * Retrieve the value of the operation by its index. The index 
 * is the position of the operation as it was added to the builder.
 *
 * @param {number} index
 *
 * @since 2.1.4
 * @volatile
 */
DocumentFragment.prototype.contentByIndex = function() {
  if (!this.indexMap) {
    this.indexMap = {};
    for (var i = 0; i < this.contents.length; ++i) {
  ...
  return this._contentByIndex(this.indexMap[path]);
};

/**
 * Retrieve the value of the operation by its path. The path 
 * is the path provided to the operation
 *
 * @param {string} path
 *
 * @since 2.1.4
 ...
 * @volatile
 */
MutateInBuilder.prototype.pushFront = function(path, value, createParents) {
 ...
 * @volatile
 */
MutateInBuilder.prototype.pushBack = function(path, value, createParents) {
 ...
 * @volatile
 */
MutateInBuilder.prototype.addUnique = function(path, value, createParents) {
