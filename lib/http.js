...
module.exports.handleRestResponse = function handleRestResponse(error, response, innerCallback) {
  var body;
  ...
  if (!body) {
    return innerCallback(new Error("Unknown REST Error"), null);
  }
...
module.exports.view = function(cb, ddoc, name, query) {
  ...
  return new viewQuery.ViewQuery(cb, ddoc, name, query);
};
