...
class ViewIndexManager {
  ...
  /**
   * @typedef {function(Error, DesignDocument[])} GetAllDesignDocumentsCallback
   */
  /**
   *
   * @param {*} [options]
  ...
  /**
   * @typedef {function(Error, DesignDocument)} GetDesignDocumentCallback
   */
  /**
   *
  ...
  /**
   * @typedef {function(Error, boolean)} UpsertDesignDocumentCallback
   */
  /**
   *
  ...
  /**
   * @typedef {function(Error, boolean)} DropDesignDocumentCallback
   */
  /**
   *
   * @param {string} designDocName
  ...
  /**
   * @typedef {function(Error, boolean)} PublishDesignDocumentCallback
   */
  /**
   *
   * @param {string} designDocName
