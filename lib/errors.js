 ...
 * @category Errors
 */
class AnalyticsIndexAlreadyExistsError extends CouchbaseError {
  constructor(...args) {
    super('analytics index already exists', ...args)
    Error.captureStackTrace(this, AnalyticsIndexAlreadyExistsError)
  }
}
exports.AnalyticsIndexAlreadyExistsError = AnalyticsIndexAlreadyExistsError;

/**
 * @category Errors
 */
class AnalyticsIndexNotFoundError extends CouchbaseError {
  constructor(...args) {
    super('analytics index not found', ...args)
    Error.captureStackTrace(this, AnalyticsIndexNotFoundError)
  }
}
exports.AnalyticsIndexNotFoundError = AnalyticsIndexNotFoundError;

/**
 * @category Errors
 */
class QueryIndexAlreadyExistsError extends CouchbaseError {
  constructor(...args) {
    super('query index already exists', ...args)
    Error.captureStackTrace(this, QueryIndexAlreadyExistsError)
  }
}
exports.QueryIndexAlreadyExistsError = QueryIndexAlreadyExistsError;

/**
 * @category Errors
 */
class QueryIndexNotFoundError extends CouchbaseError {
  constructor(...args) {
    super('query index not found', ...args)
    Error.captureStackTrace(this, QueryIndexNotFoundError)
  }
}
exports.QueryIndexNotFoundError = QueryIndexNotFoundError;
