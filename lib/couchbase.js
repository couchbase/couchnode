...
function Connection(options, callback) {
  ...
  // Ensure username is set to bucket name if not passed (for backwards compatible LCB support)
  if (!cbArgs[1]) {
    cbArgs[1] = cbArgs[3];
  }
 ...
 *   @param {integer} options.flags 32 bit value to use for the item. Note that this
