...
function lcbSeverityToLevel(severity) {
    switch (severity) {
        case CONST.LOG_TRACE: return 'silly';
        case CONST.LOG_DEBUG: return 'debug';
        case CONST.LOG_INFO: return 'info';
        case CONST.LOG_WARN: return 'warn';
        case CONST.LOG_ERROR: return 'error';
        case CONST.LOG_FATAL: return 'error';
    }
    return 'unknown';
}
